...
export default function DiscoverIdentityPage({ onNav, crossFilters = [], onToggleFilter } = {}) {
  ...
  const records = useMemo(() => makeDiscoverRecords({
    key: 'identity', count: 240, sources: SOURCES, types: TYPES, criticalities: CRITICALITY, insights: INSIGHTS, namePrefix: 'ID-USR',
  }), []);
              ...
              <div className="dev-chart-fill">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Bar
                      dataKey="Corroborated" stackId="a" fill="var(--pai-chart-teal)" radius={[2, 0, 0, 2]}
            ...
            <div className="card dev-card dev-type-card">
              ...
              <div className="dev-donut-wrap dev-donut-wrap--fixed">
                ...
                <div className="dev-donut-center">
                  ...
                  <div className="dev-donut-center__value dev-donut-center__value--sm">{activeTypesComputed.length}</div>
                </div>
              </div>
