...
// ── Home view ─────────────────────────────────────────────────────────
function PanelHome({ onSend, isFirstRun, draftQuery = '', draftToken = 0 }) {
...
// ── Panel root ────────────────────────────────────────────────────────
export default function NavigatorPanel({ open, onClose, onNav, embedded = false, initialViewMode = 'sidebar', onViewModeChange, builderMode = false, builderApi = null, builderKind = 'assessment', builderContext = null, draftQuery = '', draftToken = 0, dockSide = 'right', forceFloatToken = 0 }) {
      ...
      <div className="np-panel-content" style={{ width: embedded || isFloating ? '100%' : w }}>
        ...
        <div className="np-panel-body">
          {view === 'builder'
            ...
            : view === 'home'
            ? <PanelHome onSend={handleSend} isFirstRun={isFirstRun} draftQuery={draftQuery} draftToken={draftToken} />
            : <PanelChat
                query={activeQuery}
                onNewChat={handleNew}
                onSend={handleSend}
